...
Example specifications. Note that there are other types of instances besides t2 (e.g. T3, M4 etc).
...
> See [createbucket.MD](https://github.com/shenjean/cloud-classroom/blob/main/createbucket.MD) on how to create a S3 bucket for data storage
> See [CLI.MD](https://github.com/shenjean/cloud-classroom/blob/main/CLI.MD) contains instructions on how to copy files to/from your S3 bucket

## Clean up Amazon EC2 Resources

Once you are done with your work, remember to terminate the cluster and
empty/delete your designated Amazon S3 bucket (see [emptybucket.MD](https://github.com/shenjean/cloud-classroom/blob/main/emptybucket.MD) to avoid additional
charges.
